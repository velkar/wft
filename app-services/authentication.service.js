(function () {
    ...
    function AuthenticationService($http, $cookies, $rootScope, $timeout, UserService) {
        ...
        function setCredentials(username, password) {
            console.log("setCredentials starts ");
            var authdata = Base64.encode(username + ':' + password);
            console.log("Setting credentials in rootScope ");
            $rootScope.globals = {
                currentUser: {
                    username: username,
                    authdata: authdata
            ...
            console.log("Done setting rootScope global:"+$rootScope.globals.currentUser.username);
            ...
            console.log("Done setting cookies with Authorization factors ");
        }
